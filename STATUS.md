...
- Working on: PR #254 — CI run 25848479284 still in progress (07:47:21Z
  start, ~3 min elapsed at iter-689 check). Auto-merge SQUASH armed;
  idle this iteration awaiting CI.
