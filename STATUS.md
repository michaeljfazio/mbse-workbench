...
## Last test run
- Command: CI run `25778712436` on PR #214 head `e4d345e` — IN_PROGRESS, E2E step still running (~7 min in; now 04:48Z). Earlier steps (typecheck/lint/unit/build/install) all green.
- Result: pending
