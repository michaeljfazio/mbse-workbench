...
- Working on: PR #254 — first CI run 25845920416 GREEN at 06:49Z but
  branch was BEHIND main; updated branch via `gh pr update-branch 254`.
  Auto-merge SQUASH still armed; mergeStateStatus=BLOCKED pending CI
  re-run on the new merge commit.
