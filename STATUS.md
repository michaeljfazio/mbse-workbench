...
- Working on: PR #254 — CI run 25847085564 still on "E2E tests" step
  (started 07:17:31Z, ~16min elapsed). Auto-merge SQUASH remains armed.
  No state change vs iter-652.
