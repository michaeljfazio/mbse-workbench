...
- 2026-05-13 (iter-245): **E2E still in_progress at 05:46Z** (same wall-clock minute as iter-244 — sub-minute reinvocation). Scheduling longer wakeup (~4min) to land near typical 8–12min completion window.
