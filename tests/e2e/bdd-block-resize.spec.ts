...
async function addBlock(page: Page): Promise<Locator> {
  ...
  // canonical palette drag (PartDefinition group → BDD canvas).
  ...
  // Cascade drop positions on a 2×N grid with step sizes larger than a
  // Block's bounding box so sequential blocks don't overlap.
